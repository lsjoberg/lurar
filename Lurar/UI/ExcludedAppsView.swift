...
/// the new set. Excluded apps' audio bypasses Lurar and plays through the
...
struct ExcludedAppsView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("Audio from these apps bypasses Lurar and plays directly through your output device. Useful for voice/video calls and apps that ship their own audio processing.")
                .font(.callout)
    ...
    private var footerSummary: String {
        ...
        switch count {
        case 0: return "Nothing excluded \u{2014} all apps go through Lurar."
...
private struct AppRow: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            .controlSize(.small)
            .labelsHidden()
            .help(isExcluded ? "Excluded \u{2014} audio bypasses Lurar" : "Routed through Lurar")
        }
