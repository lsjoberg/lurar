...
struct OnboardingPermissionView: View {
    ...
    private var headerSubtitle: String {
        ...
        case .success: return "Lurar is processing your audio now."
        }
    }
    ...
    private var successExplanation: some View {
        Text("Permission granted. Lurar is now applying your selected preset to system audio. You can close this window — Lurar lives in the menu bar and will start automatically next time.")
            .font(.callout)
            .fixedSize(horizontal: false, vertical: true)
    }
