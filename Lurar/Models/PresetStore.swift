...
private let log = Logger(subsystem: "app.lurar.Lurar", category: "PresetStore")

/// Owns the user's preset library. Lives by default at
/// `~/Library/Application Support/Lurar/presets.json`, and can be redirected
...
final class PresetStore: ObservableObject {
    ...
    static let ubiquityContainerID = "iCloud.app.lurar.Lurar"
    ...
    private static let migrationDefaultsKey = "lurar.presets.migratedBuiltIns_v1"

    /// One-time migration: prior Lurar versions seeded AutoEq presets directly into
