...
nonisolated(unsafe) private var rtCrossfeedEnabled: Bool = true
...
final class EQEngine: ObservableObject {
    ...
    @Published private(set) var crossfeedEnabled: Bool = true
    ...
    static let crossfeedEnabledDefaultsKey = "lurar.crossfeedEnabled"
    ...
    init() {
        ...
        let crossfeedStored = UserDefaults.standard.object(forKey: Self.crossfeedEnabledDefaultsKey) as? Bool
    ...
    func start(output: AudioDevice) {
        ...
        do {
            ...
            let loudEQ = AVAudioUnitEQ(numberOfBands: 0)
    ...
    private func applyAudioState() {
        ...
        loudEQ.globalGain = loudnessOffsetDB
